...
export const HelloWorldParamsFields: React.FunctionComponent<
  ActionParamsProps<HelloWorldActionParams>
> = ({
  actionParams,
  editAction,
  index,
  ...
  return (
    <>
      <EuiFormRow
        id="loggingLevel"
        fullWidth
        label={i18n.translate('xpack.stackConnectors.components.helloWorld.logLevelFieldLabel', {
      ...
      <TextAreaWithMessageVariables
        ...
        label={i18n.translate('xpack.stackConnectors.components.helloWorld.logMessageFieldLabel', {
...
export { HelloWorldParamsFields as default };
